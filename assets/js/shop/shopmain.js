...
// clear timeout end
//28.54837809919135, 77.21615027958029
// map
function initializeMap() {
    var map = new google.maps.Map(document.getElementById("map"), {
        zoom: 16,
        center: new google.maps.LatLng(28.54837809919135, 77.21615027958029),
        panControl: false,
...
window.onload = function() {
    ...
    // tabs line
    $(".js-line-link").on("click", function() {
        $(this)
            .closest(".js-line")
    ...
    $(function() {
        ...
        $(".desktop .js-nav-item").on("mouseleave", function() {
            mouseOutNav(
                $(this),
                $(".js-nav-button"),
                $(".js-nav-item"),
        ...
        $(".mob .js-nav-button").on("click", function() {
            clickNav(
                $(this),
                $(".js-nav-button"),
                $(".js-nav-item"),
        ...
        $(".js-mob-close").on("click", function() {
            timerOut(navTimer);
        ...
        // slidedown
        $(".js-slidedown-button").on("click", function(e) {
            e.preventDefault();
            $(this)
                .toggleClass("active")
